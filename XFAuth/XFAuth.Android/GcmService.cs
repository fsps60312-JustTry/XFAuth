...
namespace XFAuth.Droid
{
    ...
    {
        public static string[] SENDER_IDS = new string[] { "612823773798" };
    }
    [Service]
    public class GcmService:GcmServiceBase
    {
        ...
        public static MobileServiceClient MobileService = new MobileServiceClient("http://appmobilenotification.azurewebsites.net/");
        ...
        {
            Log.Info("PushHandlerBoradcastReceiver", "GCM Message Received!");
